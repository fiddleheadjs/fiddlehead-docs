...
export let RoundsAndMatches = ({rounds, matchesById, latestMatchDate, quitPlayerIdSet}) => {
    return (
                    ...
                    <TableResponsive>
                        <table>
                            {pairs.map(({firstPlayer, secondPlayer}) => {
                                ...
                                if (quitPlayerIdSet.has(firstPlayer.id) || quitPlayerIdSet.has(secondPlayer.id)) {
                                    result = -2;
                                }
